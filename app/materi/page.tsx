...
import { ArrowLeft, Heart, Sparkles, Users, Clock, BookOpen, Settings, Loader2 } from "lucide-react"
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-800 mb-4">Pilih Materi yang Ingin Dipelajari</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Setiap materi dirancang khusus untuk ibu-ibu muda dengan bahasa yang mudah dipahami dan tips praktis yang
            bisa langsung diterapkan di rumah.
          </p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          {materials.map((material) => {
            const IconComponent = categoryIcons[material.category as keyof typeof categoryIcons] || BookOpen
            const colorClass =
              categoryColors[material.category as keyof typeof categoryColors] || "bg-gray-100 text-gray-600"
              ...
              <Card key={material.id} className="hover:shadow-lg transition-shadow cursor-pointer">
                ...
                <CardContent>
                  ...
                  <div className="space-y-2 mb-4">
                    <p className="text-sm font-medium text-gray-700">Yang akan dipelajari:</p>
        ...
        <div className="bg-gradient-to-r from-pink-500 to-purple-600 rounded-lg p-8 text-white text-center">
          ...
          <p className="mb-6 opacity-90">
            Setelah membaca materi, jangan ragu untuk bertanya kepada asisten AI kami. Dapatkan jawaban yang disesuaikan
