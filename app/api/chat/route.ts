...
export async function POST(request: NextRequest) {
  try {
    ...
    // Simulasi delay untuk pengalaman yang realistis
...
const generateAIResponse = (message: string): string => {
  ...
  if (
    ...
    if (lowerMessage.includes("anak") || lowerMessage.includes("bayi") || lowerMessage.includes("balita")) {
  ...
  if (
    ...
    if (lowerMessage.includes("bayi") || lowerMessage.includes("mpasi")) {
      ...
      if (lowerMessage.includes("susah makan") || lowerMessage.includes("tidak mau")) {
    ...
    if (lowerMessage.includes("gemuk") || lowerMessage.includes("obesitas") || lowerMessage.includes("kegemukan")) {
  ...
  if (lowerMessage.includes("gigi") || lowerMessage.includes("sikat gigi") || lowerMessage.includes("sakit gigi")) {
    if (lowerMessage.includes("tidak mau") || lowerMessage.includes("susah") || lowerMessage.includes("menolak")) {
    ...
    if (lowerMessage.includes("sakit") || lowerMessage.includes("nyeri") || lowerMessage.includes("bengkak")) {
    ...
    if (lowerMessage.includes("berlubang") || lowerMessage.includes("karies") || lowerMessage.includes("hitam")) {
  ...
  if (
    ...
    if (lowerMessage.includes("demam berdarah") || lowerMessage.includes("dbd") || lowerMessage.includes("nyamuk")) {
    ...
    if (lowerMessage.includes("cuci tangan") || lowerMessage.includes("sabun")) {
    ...
    if (lowerMessage.includes("diare") || lowerMessage.includes("mencret") || lowerMessage.includes("sakit perut")) {
  ...
  if (lowerMessage.includes("hamil") || lowerMessage.includes("ibu hamil") || lowerMessage.includes("mengandung")) {
    ...
    if (lowerMessage.includes("makanan") || lowerMessage.includes("gizi") || lowerMessage.includes("nutrisi")) {
  ...
  if (lowerMessage.includes("anak") && (lowerMessage.includes("demam") || lowerMessage.includes("panas"))) {
  ...
  if (lowerMessage.includes("anak") && (lowerMessage.includes("batuk") || lowerMessage.includes("pilek"))) {
