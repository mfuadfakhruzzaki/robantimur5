...
function ProfileContent() {
  ...
  const fetchUserData = async () => {
    ...
    try {
      ...
      const [profileResult, statsResult, activitiesResult, savedResult] =
      ...
      setFormData({
        ...
        village: profileResult.data.village || "",
      ...
      // Handle saved content data
      if (savedResult.error) {
        console.error("Error fetching saved content:", savedResult.error);
      } else if (savedResult.data) {
        setSavedContent(savedResult.data);
      }
    } catch (error: any) {
