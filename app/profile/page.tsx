    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">Terjadi kesalahan saat memuat profil Anda.</p>
              ...
              <Card className="mt-6">
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-center">
                    <div>
                      <div className="text-lg font-bold text-blue-600">{stats.articles_read}</div>
                      <div className="text-xs text-gray-600">Artikel</div>
                    </div>
                    <div>
                      <div className="text-lg font-bold text-green-600">{stats.questions_asked}</div>
                      <div className="text-xs text-gray-600">Pertanyaan</div>
                    </div>
                    <div>
                      <div className="text-lg font-bold text-purple-600">{stats.community_posts}</div>
                      <div className="text-xs text-gray-600">Postingan</div>
                    </div>
                    <div>
                      <div className="text-lg font-bold text-yellow-600">{stats.helpful_answers}</div>
                    ...
                    {activities.map((activity) => (
                      <div key={activity.id} className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center space-x-2">
                            <span className="text-sm font-medium">{getActivityTypeText(activity.activity_type)}</span>
                          ...
                          <p className="text-sm text-gray-600">{activity.activity_title}</p>
                      ...
                      <div key={content.id} className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-gray-400 mt-1">
                            Disimpan: {new Date(content.saved_at).toLocaleDateString("id-ID")}
                          </p>
                        </div>
                      </div>
                    ))}
