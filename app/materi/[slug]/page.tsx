        ...
        <div className="max-w-4xl mx-auto">
            ...
            <Card className="mb-6">
              <CardContent className="p-6">
                ...
                {material.video_description && (
                  <p className="text-gray-600">{material.video_description}</p>
                )}
              </CardContent>
            </Card>
          )}
                ...
                {material.content.split("\n").map((line, index) => {
                  ...
                  if (line.startsWith("#### ")) {
                    return (
                      <h4
                        key={index}
                        className="text-base font-medium mt-3 mb-2 text-gray-700"
                      >
                        {line.substring(5)}
                      </h4>
                    );
                  ...
                  if (line.startsWith("✅ ")) {
                    return (
                      <div
                        key={index}
                        className="flex items-center mb-2 text-green-600"
                      >
                  ...
                  if (line.startsWith("⚠️ ")) {
                    return (
                      <div
                        key={index}
                        className="flex items-center mb-2 text-orange-600"
                      >
                  ...
                  if (line.startsWith("*") && line.endsWith("*")) {
                    return (
                      <p
                        key={index}
                        className="italic text-gray-600 mt-4 p-4 bg-gray-50 rounded-lg"
                      >
                ...
                <div className="aspect-video bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-gray-500 max-w-md">
                      Kami sedang menyiapkan video edukasi untuk materi ini.
                      Video akan membantu Anda memahami topik dengan lebih mudah
                      dan menarik.
                    </p>
                  </div>
                </div>
          ...
          <div className="mt-8 bg-gradient-to-r from-pink-500 to-purple-600 rounded-lg p-6 text-white text-center">
            ...
            <p className="mb-4 opacity-90">
              Tanyakan langsung kepada asisten AI kami untuk mendapatkan jawaban
              yang lebih spesifik sesuai situasi keluarga Anda.
            </p>
